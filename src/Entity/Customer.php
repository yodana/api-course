...
class Customer
{
     ...
     * @Assert\Length(min=3, minMessage="Le nom doit faire min 3", max=255, maxMessage="Le prenom ne doit pas depasser 255")
     */
    private $lastName;
     ...
     * @Groups({"customers_read"})
     * @Assert\NotBlank(message="l'user doit etre valide")
     */
    private $user;
